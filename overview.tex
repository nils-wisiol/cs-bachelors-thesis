\chapter{A brief Overview of Proof Systems} \label{chpOverview}
  ...
  \TODO{tell some history of this question \cite[p. 1]{KM00}}The following lemma gives a partial answer to the basic question what languages do have optimal proof systems. Although Koebler et al. omitted the proof of the following theorem due to its straightforwardness, we will give a proof for the purpose of this thesis.
